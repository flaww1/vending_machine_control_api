...
async function getAllMachines({type, location, sort, status}) {
    try {
        // Define the filter options based on the provided parameters
        const filterOptions = {};
        ...
        // Define the sort options based on the provided sort parameter
        let sortOptions = {};
        ...
        // Fetch the machines from the database based on the filter and sort options
        ...
        console.error(error);
        throw new Error('An error occurred while fetching machines.');
    }
}
