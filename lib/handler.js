...
const {getMaintenanceRequestById, getProviderById} = require("./request");
...
async function providerMaintenanceHandler(maintenanceId) {
    try {
        // Retrieve the maintenance request details from the database based on maintenanceId
        const maintenanceRequest = await getMaintenanceRequestById(maintenanceId);
        const providerId = maintenanceRequest.providerId;

        // Retrieve the provider details from the database based on providerId
        ...
        const mailOptions = {
            ...
            text: `A new maintenance request has been created for machine ${maintenanceRequest.machineId}. Please review the details and take necessary action.\n\nRequest ID: ${maintenanceRequest.maintenanceId}\nType: ${maintenanceRequest.type}\nPriority: ${maintenanceRequest.priority}\nDescription: ${maintenanceRequest.description}`,
        };
